...
import { createPostSchema, TCardFormValues } from "../../validations/createPostSchema";
    ...
    return (
        <CreateCard>
            <form className="card__modal" onSubmit={handleSubmit(submit)}>
                <div className="title__and__button"><h2>Título</h2> <span className="exit__button" onClick={(e) => {closeModal()}}>X</span></div>
                ...
                <button type="submit" className="post__button">Postar</button>
            </form>
        </CreateCard>
    )
}